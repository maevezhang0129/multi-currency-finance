...
**只为一个人做：我自己。** 用户只有一个不是局限，是一把尺子——正因为知道用户是谁，
才能很快判断某个功能该不该做。

**现成工具让我放弃的那一点**：它们用今天的汇率去折算历史交易。隔一周再打开，
去年的消费金额就变了。这对「我现在总共值多少钱」是合理的，对我真正想问的
「我的消费习惯有没有变」则完全没用——后者只有在过去不动的前提下才成立。
所以有了[折算值冻结](#三折算值冻结永不重算)，整个项目是围着这一条决定搭起来的。

**砍掉的**：账号、预算、银行对接、多人协作、AI 建议。第一条养活了其余几条——
不做账号就不用做登录、不用做找回密码、也不会存着一堆别人的财务数据等着泄露。
正是这一刀，让一个人的项目能做完，而不是永远停在半成品。
